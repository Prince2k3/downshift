...
public struct SavingsReport: Sendable, Equatable {
    ...
    /// Manual turns in sessions jev routed, over all turns in those sessions: how often the
...
/// `jev savings --since`: `7d`, `24h`, `2w`, `all`, or a date (`2026-09-01`, UTC).
