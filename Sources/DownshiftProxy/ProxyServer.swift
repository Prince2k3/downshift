...
/// The loopback proxy `dshift serve`, `dshift claude` and `dshift codex` run: Claude traffic at the
...
public enum ProxyServer {
    ...
    public static func makeApplication(_ configuration: Configuration, client: HTTPClient, dumper: FixtureDumper?,
        ...
        return Application(
            ...
            configuration: .init(address: .hostname("127.0.0.1", port: configuration.port), serverName: "dshift"),
