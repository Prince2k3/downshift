...
@Suite struct JSONValueTests {
    @Test("compact JSON round-trips byte-for-byte", arguments: [
        ...
        #"{"model":"downshift","messages":[{"role":"user","content":"héllo 🌍 \"q\" \\ \n\t\u0001"}]}"#,
        #"[]"#, #"{}"#, #""""#, #"0"#, #"-12.340e+05"#,
        #"{"dup":1,"dup":2}"#,
    ...
    @Test func editsReplaceInPlace() throws {
        var value = try JSONValue.parse(#"{"model":"downshift","max_tokens":10,"stream":true}"#)
    ...
    /// Captured request bodies (from `DSHIFT_DUMP`) must round-trip exactly,
